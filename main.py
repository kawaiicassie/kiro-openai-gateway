...
def validate_configuration() -> None:
    ...
    if not env_file_exists and not SKIP_ENV_FILE_CHECK:
        ...
        if not has_refresh_token and not has_creds_file and not has_creds_json and not has_cli_db:
            errors.append(
...
async def lifespan(app: FastAPI):
    ...
    # Create AuthManager
    # Priority: JSON string > SQLite DB > JSON file > environment variables
